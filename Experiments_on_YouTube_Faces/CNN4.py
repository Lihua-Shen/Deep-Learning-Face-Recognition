...
class DeepID:
    ...
    def layer_params(self, nkerns=[20,40,60]):
        src_channel = 3
        ...
        self.result_image_shape  = (self.batch_size, nkerns[2], 5, 4)
    ...
    def build_train_model(self):
        self.params = self.softmax_layer.params + self.deepid_layer.params \
    ...
    def train(self, n_epochs, learning_rate):
        ...
        while epoch < n_epochs:
            ...
            print '\nepoch %i, train_score %f, test_score %f' % (epoch, train_score, valid_score)
...
if __name__ == '__main__':
    if len(sys.argv) != 4:
        ...
        sys.exit()
    simple_deepid(learning_rate=0.01, n_epochs=50, dataset=(sys.argv[1], sys.argv[2]), params_file=sys.argv[3], nkerns=[20,40,60], batch_size=500, n_hidden=160, n_out=1595, acti_func=relu)
