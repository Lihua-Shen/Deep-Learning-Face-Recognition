...
def evaluate_olivettifaces(learning_rate=0.05, n_epochs=200,
    ...
    layer2 = LeNetConvPoolLayer(
        rng,
        input=layer1.output,
        image_shape=(batch_size, nkerns[1], 11, 9),
    ...
    layer4 = LogisticRegression(input=layer3.output, n_in=2000, n_out=40)   
        ...
        for minibatch_index in numpy.arange(n_train_batches):
            ...
            if (iter + 1) % test_frequency == 0:
                ...
                if this_test_loss < best_test_loss:
                    ...
                    best_iter = iter
                    save_params(layer0.params,layer1.params,layer2.params,layer3.params,layer4.params)
